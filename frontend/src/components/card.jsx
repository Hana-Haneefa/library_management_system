...
function BookCard({ imageSrc, title, author, availability, genre }) {
  ...
  return (
    <div className="bookCard  w-50 h-72 mx-5 relative group overflow-hidden rounded-md">
      {/* image div */}
      <img
      ...
      {/* text div */}
      <div className="absolute bottom-0 left-0 w-full bg-white translate-y-0 group-hover:translate-y-full opacity-100 group-hover:opacity-0 transition-all duration-500 p-2 flex flex-col items-center justify-between gap-1">
